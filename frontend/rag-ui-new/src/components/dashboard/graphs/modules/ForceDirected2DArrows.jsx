/**
 * Force-Directed 2D Graph with Directional Arrows
 * 
 * Enhanced version with directional arrows on links to show relationship direction
 */
...
const ForceDirected2DArrows = ({ 
  ...
  const graphProps = createCommonGraphProps({
    ...
    linkDirectionalArrowLength: safeVisualizationSettings.showInterconnectivity ? 4 : 0, // Always show arrows when interconnectivity is enabled
...
export default ForceDirected2DArrows;
