...
# Add to system_inventory.sh
get_custom_software() {
    log_section "CUSTOM SOFTWARE"
    
    safe_exec "your-command --version" "Your Software Version"
    safe_exec "your-other-command --list" "Your Software List"
    
    log_success "Custom software information collected"
}
